...
_EN: dict[str, str] = {
    ...
    "prov.ads_txt_accounts": "**Shared DIRECT accounts** (operator-tier first — rare = strong; manager = shared across most domains):",
...
_ZH: dict[str, str] = {
    ...
    "prov.ads_txt_accounts": "**共用 DIRECT 帳號**(operator 級置頂——稀有=強;manager=多數網域共用):",
