...
_ZH: dict[str, str] = {
    ...
    "clusters.wrappers_caption": "(original_domain → final_domain) 配對：URL 跳轉時跨越網域。「包裝器」是貼文中分享的網域，「最終」是點擊後真正落地的網域。典型例子：crawlerlanding → visitorlanding——很多 crawler-landing.example 短連結全部 redirect 到 visitor-landing.example。",
