...
_EN: dict[str, str] = {
    ...
    "crosscase.lookup_placeholder": "e.g. G-BG0P58H1GN",
    ...
    "clusters.wrappers_caption": "Pairs of (original_domain → final_domain) where the redirect chain crossed domains. The 'wrapper' is what posters share; the 'final' is where the click actually lands. Picread → maimai is the canonical example: many short URLs on picread.net that all resolve to maimai.pro after a 2-hop redirect.",
...
_ZH: dict[str, str] = {
    ...
    "crosscase.lookup_placeholder": "例如 G-BG0P58H1GN",
    ...
    "clusters.wrappers_caption": "(original_domain → final_domain) 配對：URL 跳轉時跨越網域。「包裝器」是貼文中分享的網域，「最終」是點擊後真正落地的網域。典型例子：picread → maimai——很多 picread.net 短連結全部 redirect 到 maimai.pro。",
